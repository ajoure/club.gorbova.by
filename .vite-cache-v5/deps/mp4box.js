...
var Endianness = (function(Endianness2) {
...
var Log = {
  ...
  error(module, msg, isofile) {
    if (isofile == null ? void 0 : isofile.onError) isofile.onError(module, msg);
...
var AudioSampleEntry = class extends SampleEntry {
  parse(stream) {
    ...
    if ((_b = (_a286 = stream.isofile) == null ? void 0 : _a286.ftyp) == null ? void 0 : _b.major_brand.includes("qt")) {
...
var mp4aSampleEntry = (_a96 = class extends AudioSampleEntry {
  ...
  getCodec() {
    var _a286;
    const baseCodec = super.getCodec();
    const esds = this.esds ?? ((_a286 = this.wave) == null ? void 0 : _a286.esds);
    if (esds && esds.esd) {
...
var ISOFile = class ISOFile2 {
  ...
  */
  static writeInitializationSegment(ftyp, moov, total_duration, normalizeAudioSampleEntryTrackIds) {
    ...
    try {
      ...
      for (let i = 0; i < moov.traks.length; i++) {
        ...
        trex.default_sample_duration = ((_a286 = moov.traks[i].samples[0]) == null ? void 0 : _a286.duration) ?? 0;
  ...
  static normalizeAudioSampleEntriesForMSEFragmentedInit(traks, normalizeAudioSampleEntryTrackIds) {
    ...
    for (const trak of traks) {
      if (!(normalizeAudioSampleEntryTrackIds == null ? void 0 : normalizeAudioSampleEntryTrackIds.has(trak.tkhd.track_id))) continue;
      for (const sampleEntry of ((_a286 = trak.mdia.minf.stbl.stsd) == null ? void 0 : _a286.entries) ?? []) {
        if (!(sampleEntry instanceof mp4aSampleEntry)) continue;
        const esds = (_b = sampleEntry.wave) == null ? void 0 : _b.esds;
        ...
        const boxesWithoutWave = Array.isArray(sampleEntry.boxes) ? sampleEntry.boxes.filter((box) => (box == null ? void 0 : box.type) !== "wave" && (box == null ? void 0 : box.type) !== "esds") : [];
  ...
  initializeSegmentation(mode) {
    ...
    const fragmentDuration = (_c = (_b = (_a286 = this.moov) == null ? void 0 : _a286.mvex) == null ? void 0 : _b.mehd) == null ? void 0 : _c.fragment_duration;
...
var descriptor_exports = __exportAll({
...
var Descriptor = class Descriptor2 {
  ...
  parseRemainingDescriptors(stream) {
    ...
    while (stream.getPosition() < start2 + this.size) {
      const desc = (_a286 = this.parseOneDescriptor) == null ? void 0 : _a286.call(this, stream);
...
var VTTin4Parser = class {
  parseSample(data) {
    ...
    while (!stream.isEof()) {
      ...
      if (cue.code === 1 && ((_a286 = cue.box) == null ? void 0 : _a286.type) === "vttc") cues.push(cue.box);
    }
    return cues;
  }
...
var all_boxes_exports = __exportAll({
  CoLLBox: () => CoLLBox,
