...
export interface CrmAutomationTriggerDefinition {
  id: string;
  category:
    "deal" | "field" | "payment" | "communication" | "calendar" | "system";
  title: string;
  description: string;
  ...
  [
    {
      ...
      description:
        "Запускает правило после перехода сделки в выбранную стадию воронки.",
    ...
    },
    {
      ...
      description:
        "Срабатывает, когда ожидаемый платёж не получен к заданному сроку.",
      availability: "planned",
    },
    {
      id: "email_opened",
      ...
      description:
        "Реагирует на событие трекинга Email, если оно доступно у канала отправки.",
      availability: "planned",
    },
    {
      id: "email_clicked",
      ...
      description:
        "Запускается после зафиксированного перехода по ссылке из письма.",
      availability: "planned",
    },
    {
      id: "telegram_reply",
      ...
      description:
        "Реагирует на новое входящее сообщение клиента, связанное со сделкой.",
      availability: "planned",
    },
    {
      id: "at_datetime",
      ...
      description:
        "Однократный запуск по выбранным дате, времени и часовому поясу.",
      availability: "available",
    ...
    },
    {
      ...
      description:
        "В первой версии — запуск через период после входа сделки в выбранную стадию; новые события будут добавляться тем же контрактом.",
      availability: "available",
      requiresSchedule: true,
    },
    {
      ...
      title: "В день недели",
      description:
        "Повторяет запуск в выбранные дни недели в часовом поясе правила.",
      availability: "available",
      requiresSchedule: true,
    },
    {
      ...
      title: "В день месяца",
      description:
        "Например, первого числа каждого месяца или в заданный день месяца.",
      availability: "available",
      requiresSchedule: true,
    },
    {
      ...
      description:
        "Первый, последний или N-й рабочий день месяца после подключения календаря праздников организации.",
      availability: "planned",
      requiresSchedule: true,
    },
    {
      ...
      description:
        "Позволит сотруднику или защищённой интеграции запустить опубликованное правило явно.",
      availability: "planned",
    },
  ];
