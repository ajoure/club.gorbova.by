/**
 * Canonical helper: строит человекочитаемое «наименование услуги / назначение платежа»
 * из snapshot состава заказа (primary + модули-аддоны).
 *
 * Формат: «<primary.product_name>, тариф <primary.tariff_name>»
 *   плюс, если addons ≠ ∅: «. Модуль <n1>. Модуль <n2>...»
 *
 * Никаких висячих точек/пробелов, никаких undefined-placeholder.
 */
