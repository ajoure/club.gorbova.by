...
const stats = [{
  ...
  icon: Users,
  value: "1000+",
  label: "учеников обучено"
}, {
  icon: BookOpen,
  value: "600+",
  label: "видео в базе знаний"
}, {
  icon: Building2,
  value: "15+",
  label: "лет опыта"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection animation="fade-right">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>Основатель компаний под брендом AJOURE и Академии бухгалтера. Провела более 400 проверок, обучила тысячи бухгалтеров.</p>
                <p>
            ...
            <AnimatedSection animation="fade-left">
              <div className="grid grid-cols-2 gap-4">
                {stats.map((stat, index) => <div key={index} className="p-6 rounded-2xl border border-border/50 text-center" style={{
