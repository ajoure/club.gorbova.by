...
export function KanbanDealCard({ deal, onOpen, isDragging, onMoveTo, availableStages }: Props) {
  ...
  return (
    <div
      ...
      className={cn(
        "group rounded-xl p-3 border border-border/30 cursor-grab active:cursor-grabbing transition-all duration-150",
    ...
    >
      ...
      {/* Hover quick actions */}
      <div className="hidden group-hover:flex items-center gap-1 mt-2 pt-2 border-t border-border/20">
