  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mt-4 p-4 bg-muted/30 rounded-lg [&>div]:min-w-0">
      ...
      <p className="col-span-full text-xs text-muted-foreground">
        Фильтр учитывает текущее версионное назначение платежа. При изменении менеджера
        в сделке связанные платежи и возвраты получают новое текущее назначение,
        а предыдущие назначения сохраняются в истории.
      </p>
    </div>
  );
}
