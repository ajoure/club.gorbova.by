  ...
  return (
     <div className="relative isolate rounded-3xl p-4 overflow-hidden">
      ...
      <div
        ...
        className="relative table-scroll-x flex md:grid gap-3 md:grid-cols-6 snap-x snap-mandatory md:snap-none -mx-1 px-1 md:mx-0 md:px-0 [&>*]:shrink-0 md:[&>*]:shrink [&>*]:basis-[44%] sm:[&>*]:basis-[30%] md:[&>*]:basis-auto [&>*]:snap-start"
      >
       <GlassStatCard
        title="Платежи"
