...
function LiveEventLegacy() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1600px] w-full mx-auto px-3 md:px-6 pb-3 md:pb-6 flex flex-col lg:flex-1 lg:flex-row lg:items-start gap-3 md:gap-4 min-h-0 max-lg:sticky max-lg:top-0 max-lg:h-[100dvh] max-lg:overflow-hidden max-lg:bg-background max-lg:z-[1]">
