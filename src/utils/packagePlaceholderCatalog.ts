...
const PACKAGE_UL: PackagePlaceholderItem[] = [
  ...
  ready("package_ul", "Адрес: улица", "FLD-000334", "FLD-000035",
    "client_legal_details", "leg_address_street", "package.ul.address_street"),
  ready("package_ul", "Адрес: дом", "FLD-000331", "FLD-000036",
    "client_legal_details", "leg_address_house", "package.ul.address_house"),
  ready("package_ul", "Адрес: корпус", "FLD-000325", "FLD-000037",
    "client_legal_details", "leg_address_building", "package.ul.address_building"),
  ready("package_ul", "Адрес: помещение/квартира", "FLD-000324", "FLD-000038",
    "client_legal_details", "leg_address_apartment", "package.ul.address_apartment"),
  ready("package_ul", "Адрес: населённый пункт", "FLD-000326", "FLD-000039",
    "client_legal_details", "leg_address_city", "package.ul.address_city"),
  ready("package_ul", "Адрес: область", "FLD-000333", "FLD-000040",
    "client_legal_details", "leg_address_region", "package.ul.address_region"),
  ready("package_ul", "Адрес: индекс", "FLD-000332", "FLD-000041",
    "client_legal_details", "leg_address_postal_code", "package.ul.address_postal_code"),
  ready("package_ul", "Адрес: страна", "FLD-000328", "FLD-000042",
    "client_legal_details", "leg_address_country", "package.ul.address_country"),
  deferred("package_ul", "Адрес: район", "FLD-000329", "missing_source_column",
    "package.ul.address_district",
    "Нет колонки leg_address_district в client_legal_details — backlog Sprint 3E."),
  deferred("package_ul", "Адрес: район города", "FLD-000327", "missing_source_column",
    "package.ul.address_city_district",
    "Нет колонки leg_address_city_district — backlog Sprint 3E."),
];
...
const PACKAGE_IP: PackagePlaceholderItem[] = [
  ...
  ready("package_ip", "Адрес: улица", "FLD-000284", "FLD-000043",
    "client_legal_details", "ent_address_street", "package.ip.address_street"),
  ready("package_ip", "Адрес: дом", "FLD-000281", "FLD-000044",
    "client_legal_details", "ent_address_house", "package.ip.address_house"),
  ready("package_ip", "Адрес: корпус", "FLD-000275", "FLD-000045",
    "client_legal_details", "ent_address_building", "package.ip.address_building"),
  ready("package_ip", "Адрес: помещение/квартира", "FLD-000274", "FLD-000046",
    "client_legal_details", "ent_address_apartment", "package.ip.address_apartment"),
  ready("package_ip", "Адрес: населённый пункт", "FLD-000276", "FLD-000047",
    "client_legal_details", "ent_address_city", "package.ip.address_city"),
  ready("package_ip", "Адрес: область", "FLD-000283", "FLD-000048",
    "client_legal_details", "ent_address_region", "package.ip.address_region"),
  ready("package_ip", "Адрес: индекс", "FLD-000282", "FLD-000049",
    "client_legal_details", "ent_address_postal_code", "package.ip.address_postal_code"),
  ready("package_ip", "Адрес: страна", "FLD-000278", "FLD-000050",
    "client_legal_details", "ent_address_country", "package.ip.address_country"),
  deferred("package_ip", "Адрес: район", "FLD-000279", "missing_source_column",
    "package.ip.address_district",
    "Нет колонки ent_address_district — backlog Sprint 3E."),
  deferred("package_ip", "Адрес: район города", "FLD-000277", "missing_source_column",
    "package.ip.address_city_district",
    "Нет колонки ent_address_city_district — backlog Sprint 3E."),
...
const PACKAGE_FL: PackagePlaceholderItem[] = [
  ...
  // Address breakdown: persons table хранит только address_structured (jsonb).
  // Плоских колонок ind_address_* нет → backlog Sprint 3E (либо JSON-path в резолвере,
  // либо новые FLD после миграции).
  deferred("package_fl", "Адрес: полный", "FLD-000303", "pending_field",
    "package.fl.address_full",
    "legal_details_persons.address_structured — jsonb; нужен FLD на jsonb-path или нормализация."),
  deferred("package_fl", "Адрес: улица", "FLD-000307", "pending_field",
    "package.fl.address_street", "См. address_full — нужен FLD на jsonb-path."),
  deferred("package_fl", "Адрес: дом", "FLD-000304", "pending_field",
    "package.fl.address_house", "См. address_full."),
  deferred("package_fl", "Адрес: корпус", "FLD-000298", "pending_field",
    "package.fl.address_building", "См. address_full."),
  deferred("package_fl", "Адрес: помещение/квартира", "FLD-000297", "pending_field",
    "package.fl.address_apartment", "См. address_full."),
  deferred("package_fl", "Адрес: населённый пункт", "FLD-000299", "pending_field",
    "package.fl.address_city", "См. address_full."),
  deferred("package_fl", "Адрес: район", "FLD-000302", "pending_field",
    "package.fl.address_district", "См. address_full."),
  deferred("package_fl", "Адрес: район города", "FLD-000300", "pending_field",
    "package.fl.address_city_district", "См. address_full."),
  deferred("package_fl", "Адрес: область", "FLD-000306", "pending_field",
    "package.fl.address_region", "См. address_full."),
  deferred("package_fl", "Адрес: индекс", "FLD-000305", "pending_field",
    "package.fl.address_postal_code", "См. address_full."),
  deferred("package_fl", "Адрес: страна", "FLD-000301", "pending_field",
    "package.fl.address_country", "См. address_full."),
  deferred("package_fl", "Банк", "FLD-000310", "missing_source_column",
    "package.fl.bank_name",
    "legal_details_persons не содержит банк-реквизитов — backlog Sprint 3E."),
  deferred("package_fl", "БИК / код банка", "FLD-000309", "missing_source_column",
    "package.fl.bank_code", "См. bank_name."),
  deferred("package_fl", "Расчётный счёт / IBAN", "FLD-000308", "missing_source_column",
    "package.fl.bank_account", "См. bank_name."),
];
