...
const messages: Record<string, string> = {
  ...
  submission_preparation_failed: 'Не удалось сохранить данные анкеты. Документ ещё не формировался. Вернитесь к анкете и повторите попытку.',
  ...
  document_save_failed: 'Не удалось сохранить запись документа. Проверьте историю перед повторной генерацией.',
  document_download_unavailable: 'Не удалось подготовить скачивание документа. Проверьте историю перед повторной генерацией.',
  batch_save_failed: 'Не удалось подтвердить сохранение результата пакета. Проверьте историю перед повторной генерацией.',
  session_save_failed: 'Не удалось сохранить состояние анкеты. Проверьте историю перед повторной генерацией.',
  role_binding_failed: 'Не удалось подготовить участника документа. Обратитесь к владельцу пакета для проверки попытки.',
  generation_in_progress: 'Эта анкета уже принята. Формирование выполняется или его результат ещё не подтверждён. Проверьте статус, не отправляя анкету заново.',
  submission_status_unavailable: 'Не удалось проверить предыдущую попытку. Повторите проверку статуса позже.',
  submission_request_conflict: 'Эта попытка уже принята с другими данными. Проверьте результат предыдущей попытки.',
  submission_request_id_required: 'Обновите страницу перед отправкой анкеты.',
