...
export const DEFAULT_MENU: MenuSettings = [
  {
    ...
    items: [
      ...
      { id: "companies", label: "Компании", path: "/admin/companies", icon: "Building2", order: 4 },
      { id: "tasks", label: "Задачи", path: "/admin/tasks", icon: "ListChecks", order: 5, permission: "users.view" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sections", label: "Разделы платформы", path: "/admin/sections", icon: "Shield", order: 6, permission: "roles.view" },
      { id: "editorial", label: "Редакция", path: "/admin/editorial", icon: "Newspaper", order: 7, permission: "news.view" },
