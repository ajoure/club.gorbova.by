...
- [x] Мобильный контакт-центр: стабилизировать переписку при клавиатуре, сенсорные действия и контекст ответа; проверить Preview на mobile/desktop без отправки сообщений.
