...
- [ ] Мобильный контакт-центр: убрать лишние строки в iPhone PWA, уплотнить историю и composer при клавиатуре; проверить Preview на mobile/desktop без отправки сообщений.
