...
- [ ] PR554 Publish plan: классифицировать 13 critical/error findings по in-scope правилу, проверить доступные GitHub checks metadata и выдать PASS/STOP без Publish.
