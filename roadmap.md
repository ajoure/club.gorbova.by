...
- [ ] PR446 (база знаний ЦБ): exact merged SHA/blob preflight → одиночный и полный managed dry-run → при PASS однократная managed migration → RLS/grants/count read-back; без импорта текстов, STT/jobs/deploy/Publish.
