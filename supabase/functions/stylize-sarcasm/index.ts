...
1. ДАТЫ — копируй БЕЗ ИЗМЕНЕНИЙ (например: "с 1 января 2025", "до 15.01.2025")
...
5. Сарказм применяй ТОЛЬКО к вводным фразам и комментариям, НЕ к фактам!

Формат:
- HTML-теги: <b>жирный</b>, <i>курсив</i>, <u>подчёркнутый</u>
