...
Верни JSON с маппингом колонок:
{
  "mapping": {
    ...
    "accessStartAt": "название колонки с датой начала доступа (если есть)",
    "accessEndAt": "название колонки с датой окончания доступа (если есть)"
  },
...
ВАЖНО для дат доступа:
- accessStartAt: ищи колонки "Дата начала", "Начало доступа", "Start date", "Доступ с", "Access start"
- accessEndAt: ищи колонки "Дата окончания", "Конец доступа", "End date", "Доступ до", "Срок до", "Access end", "Действует до"
