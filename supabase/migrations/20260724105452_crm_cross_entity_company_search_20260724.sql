-- Cross-entity company search for canonical CRM surfaces.
-- Company names remain a search facet; contacts, deals and payments keep
-- their own entities and permissions.
