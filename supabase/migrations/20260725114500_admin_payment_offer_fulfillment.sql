-- The payment-reconciliation flow must remember the exact CTA/offer selected
-- by the manager.  The existing stage-2 function remains available for old
-- callers; this overload validates and persists p_offer_id atomically in the
-- same transaction as the canonical order/payment creation.
