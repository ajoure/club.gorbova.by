-- Contact-search parity: the global dropdown must show the same active contacts
-- as /admin/contacts. Archived and merged profiles remain discoverable only via
-- their dedicated admin views, never through the default global search.
