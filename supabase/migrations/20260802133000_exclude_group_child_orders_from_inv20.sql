-- Composable purchases create several paid child orders backed by one
-- canonical payments_v2 row on the parent order. They are not missing
-- payments and must not trigger INV-20 or a payment-repair execute.
