-- === 20260723092218_crm_pipeline_automation_stage_entry_v1.sql ===
...
-- NOTE: For rollout in Lovable Cloud, remaining files v2..v17 will be applied by subsequent migration calls (Approve).
-- This first migration establishes canonical base tables/RLS/RPC/trigger and seeds feature flag = false.