...
BEGIN
  ...
  -- HARDENED (Stage 3 final): audit_logs uses actor_user_id / entity_type / entity_id / meta.
  -- The previous schema (actor_id/resource_*) does not exist and silently rolled back every
  -- successful save attempt, masking real successes during pre-proof testing.
