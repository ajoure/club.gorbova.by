...
REVOKE ALL ON FUNCTION public.contact_feed_list(uuid, text[], text, integer, integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.contact_feed_list(uuid, text[], text, integer, integer) FROM anon;
GRANT EXECUTE ON FUNCTION public.contact_feed_list(uuid, text[], text, integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.contact_feed_list(uuid, text[], text, integer, integer) TO service_role;