CREATE OR REPLACE FUNCTION public.admin_reset_user_trial(p_user_id uuid, p_product_id uuid, p_tariff_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  -- actor_type must be one of: 'user', 'system' (audit_logs_actor_type_check)
