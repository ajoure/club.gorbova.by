...
-- PATCH-1: Add full_name and avatar_url to instagram_contacts
ALTER TABLE instagram_contacts ADD COLUMN IF NOT EXISTS full_name text;
ALTER TABLE instagram_contacts ADD COLUMN IF NOT EXISTS avatar_url text;

-- Update RPC to include full_name, avatar_url, account_name
