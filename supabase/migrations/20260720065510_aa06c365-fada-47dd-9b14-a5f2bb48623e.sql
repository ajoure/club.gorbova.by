...
BEGIN
  ...
  ----------------------------------------------------------------
  -- Fixture CLD #2 — manual_replay reason
  ----------------------------------------------------------------
  INSERT INTO public.client_legal_details (
    id, profile_id, legal_form, organization_name, unp,
    legal_address, country, created_by, updated_by,
  ...
  ----------------------------------------------------------------
  -- Fixture CLD #3 — map-mismatch guard (T12)
  ----------------------------------------------------------------
  INSERT INTO public.client_legal_details (
    id, profile_id, legal_form, organization_name, unp,
    legal_address, country, created_by, updated_by,
  ...
  -- T3: re-enqueue completed CLD produces new job; second writer pass = zero delta
  DECLARE
    v_job1_second uuid;
